...
class ElectricLinesExport implements FromCollection, WithTitle, ShouldAutoSize, WithHeadings, WithMapping, WithEvents
{
    ...
    */
     ...
     * @return array
     */
    public function map($electricLine): array
    {
