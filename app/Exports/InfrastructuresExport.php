...
class InfrastructuresExport implements FromCollection, WithTitle, ShouldAutoSize, WithHeadings, WithMapping, WithEvents
{
    ...
    */
     ...
     * @return array
     */
    public function map($infrastructure): array
    {
