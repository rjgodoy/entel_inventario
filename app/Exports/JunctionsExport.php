...
class JunctionsExport implements FromCollection, WithTitle, ShouldAutoSize, WithHeadings, WithMapping, WithEvents
{
    ...
    */
     ...
     * @return array
     */
    public function map($junction): array
    {
        ...
        return [
            ...
            $junction->electric_company ? $junction->electric_company->name : null,

            $junction->junction_number,
            $junction->client_number,
            $junction->rate_type
