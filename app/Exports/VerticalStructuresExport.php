...
class VerticalStructuresExport implements FromCollection, WithTitle, ShouldAutoSize, WithHeadings, WithMapping, WithEvents
{
    ...
    */
     ...
     * @return array
     */
    public function map($verticalStructure): array
    {

        return [
            $verticalStructure->id,
            ...
            $verticalStructure->vertical_structure_type ? $verticalStructure->vertical_structure_type->vertical_structure_type : null,
