...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    PopDataChart: function PopDataChart() {
      return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(7)]).then(__webpack_require__.bind(null, /*! ./PopDataChart */ "./resources/js/components/dashboard/PopDataChart.vue"));
    }
  },
  ...
  methods: {
    ...
    downloadPops: function downloadPops() {
      ...
      axios.get("/api/pop/export?core=".concat(this.core, "&crm_id=").concat(this.selectedCrm ? this.selectedCrm.id : 0, "&zona_id=").concat(this.selectedZona ? this.selectedZona.id : 0), {
        responseType: 'blob'
