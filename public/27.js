  ...
  methods: {
    ...
    getGeneratorGroupData: function getGeneratorGroupData() {
      ...
      if (this.crmSelected == null) {
        axios.get("/api/generatorGroupData?core=".concat(this.core)).then(function (response) {
        ...
        axios.get("api/generatorGroupDataCrm?core=".concat(this.core, "&crm_id=").concat(this.crmSelected.id)).then(function (response) {
          _this.generatorGroupData = response.data.data;
        ...
        axios.get("api/generatorGroupDataZona?core=".concat(this.core, "&zona_id=").concat(this.zonaSelected.id)).then(function (response) {
          _this.generatorGroupData = response.data.data;
          ...
          _vm._l(this.generatorGroupData, function(item) {
            return _c("div", { staticClass: "column is-6" }, [
              _c("div", { staticClass: "is-size-5 has-text-weight-semibold" }, [
                _vm._v(
                  _vm._s(_vm._f("numeral")(item.q_generator_groups, "0,0"))
                )
              ]),
              _vm._v(" "),
