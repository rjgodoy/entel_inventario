...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    capacidadTotal: function capacidadTotal(latest_protection) {
                  ...
                  _c(
                    ...
                    [
                      _c("div", { staticClass: "columns" }, [
                        ...
                        _c(
                          "div",
                          { staticClass: "column is-3 has-text-right" },
                          [
                            _c("font-awesome-icon", {
                              staticClass: "has-text-grey-lighter",
                              staticStyle: { opacity: "0.5" },
                              attrs: { icon: ["fas", "plug"], size: "5x" }
                            })
                          ],
                          1
                        )
                          ...
                          _c("div", { staticClass: "has-text-centered" }, [
                            ...
                            _c(
                              ...
                              [
                                _vm._v(
                                  _vm._s(
                                    _vm._f("numeral")(_vm.consumoTablero, 0, 0)
                                  ) + " \n                                "
                                ),
                                _c("span", { staticClass: "is-size-6" }, [
                                  _vm._v("W/kW")
                      ...
                      _c(
                        ...
                        {
                          attrs: {
                            value: _vm._f("numeral")(
                              _vm.capacidadTotal(data.latest_protection)
                                ? (_vm.consumoTablero * 100) /
                                    _vm.capacidadTotal(data.latest_protection)
                                : 0,
                              "0.[00]"
                            ),
...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("tr", [
      _c("th", { staticClass: "has-text-centered is-size-6" }, [
        _vm._v("Medición R")
      ]),
      _vm._v(" "),
      _c("th", { staticClass: "has-text-centered is-size-6" }, [
