      ...
      if (this.dependencesActive == 0) {
        ...
        axios.get("/api/dependence/".concat(this.pop.id)).then(function (response) {
          ...
          if (_this2.dependences != null) {
            _this2.dependences.forEach(function (element) {
              return _this2.pops.push(element.dependence);
            });

            console.log(_this2.pops); //Set bounds of the map
