(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunks/dashboard/verticalStructures"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    downloadVerticalStructures: function downloadVerticalStructures() {
      var _this2 = this;
      ...
      axios.get('/api/verticalStructuresExport', {
        ...
        link.href = data;
        link.download = "Listado Estructuras Verticales - ".concat(_this2.middleFileName).concat(moment().format('YYYY-MM-DD hh:mm:ss'), ".xlsx");
    ...
    _c("article", { staticClass: "tile is-child box is-bold has-background" }, [
      _c(
        ...
        [
          _c("font-awesome-icon", {
            ...
            attrs: { icon: ["fas", "broadcast-tower"], size: "10x" }
          })
        ],
        1
      ),
      ...
      _c(
        "a",
        {
          ...
          on: { click: _vm.downloadVerticalStructures }
        },
        [
          _c("div", { staticClass: "columns" }, [
            _c(
      ...
      _c(
        ...
        [
          _c("p", { staticClass: "is-size-6 has-text-weight-semibold" }, [
            _vm._v("Descargar listado de Estructuras Verticales")
          ])
        ]
      )
    ])
