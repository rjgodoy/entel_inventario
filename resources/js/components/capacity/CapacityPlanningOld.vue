            ...
            <div class="column section" style="padding-top: 20px; padding-right: 10px;">
                <div class="box has-background-black-ter">
                    ...
                    <table class="table is-fullwidth has-background-black-ter has-text-white">
                        <thead>
                            <tr>
                                <th class="is-size-6 has-text-weight-semibold has-text-white" width="30%"><abbr title="id">POP</abbr></th>
                                    ...
                                    <div class="columns">
                                        ...
                                        <div class="column has-text-centered">
                                            ...
                                            <!-- <div class="columns">
                                                ...
                                                <div class="column has-text-centered">
                                                    <abbr title="id">{{ canViewClimate ? 'Energía' : 'Energía / Clima' }}</abbr>
                                                </div>
                                                <div class="column has-text-centered" v-if="canViewClimate">
                                                                ...
                                                                <div class="" style="padding-top: 10px;">
                                                                    <!-- <font-awesome-layers class="fa-lg">
                                                                        <font-awesome-icon 
                                                                            ...
                                                                            size="3x"
                                                                            /> -->
                                                                            <!-- :transform="energy <= 5 || climate <= 5 || space <= 5 ? 'shrink-6.5 up-45.2 left-2' : ((energy > 5 && energy <= 10) || (climate > 5 && climate <= 10) || (space > 5 && space <= 10) ? 'shrink-6.5 up-33.2 left-2' : 'shrink-6.5 up-21.2 left-2')"  -->
                                                                    <font-awesome-icon 
                                                                        icon="circle"
                                                                        size="2x" 
