...
library.add(farCheckCircle, faExclamationTriangle);
    ...
    export default {
        components: {
            ModalJunction: () => import(/* webpackChunkName: "chunks/capacity/modals/junction"*/'../../capacity/modals/ModalJunction'),
            ModalGenerator: () => import(/* webpackChunkName: "chunks/capacity/modals/generator"*/'../../capacity/modals/ModalGenerator'),
            ModalPowerRectifier: () => import(/* webpackChunkName: "chunks/capacity/modals/powerRectifier"*/'../../capacity/modals/ModalPowerRectifier'),
            ModalAirConditioner: () => import(/* webpackChunkName: "chunks/pop/layout/modals/airConditioner"*/'../../capacity/modals/ModalAirConditioner'),
