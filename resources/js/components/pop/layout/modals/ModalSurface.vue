                    ...
                    <div class="level">
                        ...
                        <div class="level-item">
                            <div class="has-text-centered">
                                ...
                                <div v-if="!isEditMode" class="has-text-weight-semibold is-size-5">{{ newTotalSurface | numeral(0,0) }} <span class="is-size-6">m2</span></div>
                        ...
                        <div class="level-item">
                            <div class="has-text-centered">
                                ...
                                <div v-if="!isEditMode" class="has-text-weight-semibold is-size-5">{{ newUsedSurface | numeral(0,0) }} <span class="is-size-6">m2</span></div>
                        ...
                        <div class="level-item">
                            <div class="has-text-centered">
                                ...
                                <div class="has-text-weight-semibold is-size-5">
                                    {{ availableSurface | numeral(0,0) }} <span class="is-size-6">m2</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        methods: {
            saveChanges() {
                if (!this.isEditMode && 
                    ...
                    // console.log(params)
                    axios.post(`/api/createRoomSurface/${this.sala.id}`, params).then(response => {
