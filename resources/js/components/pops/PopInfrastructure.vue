<template>
    <div class="section" style="min-height: 500px; margin: auto -48px auto -48px;">
        ...
        <section class="section has-background-white">
            <div class="columns">
                <div class="column" style="margin: -24px auto -40px auto;" v-if="verticalStructures.length">
                    <div class="field">
                ...
                <div class="column" style="margin: -24px auto -40px auto;" v-if="infrastructures.length">
                    <div class="field">
