<template>
    <div class="section" style="min-height: 500px; margin: auto -48px auto -48px;">
        ...
        <section class="section has-background-light" v-if="transformers.length">
            <div style="margin: -40px auto -40px auto;">
        ...
        <section class="section has-background-white" v-if="connectionClients.length">
            <div style="margin: -40px auto -40px auto;">
        ...
        <section class="section has-background-light" v-if="generatorGroups.length">
            <div style="margin: -40px auto -40px auto;">
